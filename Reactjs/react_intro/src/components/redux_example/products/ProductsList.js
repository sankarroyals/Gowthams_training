...
export default function ProductsList() {
  ...
  const data = useSelector((state) => state.ShoppingReducers.products);
  ...
  return (
    <Box sx={{ width: "100%" }}>
    <div><input type="text" name="" id="" placeholder="Search the products by title" style={{padding:"10px",outline:"0",borderRadius:"5px",margin:"10px",width:"500px"}} 
